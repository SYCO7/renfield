...
SCRIPT = [
    ...
    ("out", "   3/3 chains PROVEN by a real side effect (canary left the box)"),
    ("out", ""),
    ("prompt", "$ ren remediate my-agent.json"),
    ("head", "   minimal fix: remove 1 capability  ->  inbox.read_message"),
    ("ok", "   re-analysis: 0/3 critical chains remain    [PROVEN FIX]"),
    ("out", ""),
    ("prompt", "$ ren compare my-agent.json --with qwen2.5:7b --with gpt-4o"),
    ("out", "   (example output -- run it for YOUR real numbers)"),
    ("warn", "   qwen2.5:7b  2/3       gpt-4o  0/3  (resisted all)"),
]
